...
function NoteModal() {
	...
	return (
		<>
			<button
				type='button'
				className='fixed bottom-8 right-8 z-[100] flex h-16 w-16 cursor-pointer items-center justify-center rounded-full border border-[rgba(255,255,255,0.125)] bg-[rgba(43,52,76,0.56)] text-[2rem] font-bold tracking-[-0.24px] text-white backdrop-blur-[7px] backdrop-saturate-[191%]'
				onClick={openAdd}
